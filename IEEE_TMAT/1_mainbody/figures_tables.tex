\begin{figure}[!t]
\centering
\subfloat[]{\includegraphics[width=0.47\columnwidth]{figures/fig 1a.pdf}\label{fig:stacks_a}}
\hfill
\subfloat[]{\includegraphics[width=0.47\columnwidth]{figures/fig 1b.pdf}\label{fig:stacks_b}}\\
\subfloat[]{\includegraphics[width=0.47\columnwidth]{figures/1f_XRD Full.pdf}\label{fig:stacks_c}}
\hfill
\subfloat[]{\includegraphics[width=0.47\columnwidth]{figures/fig 1d.pdf}\label{fig:stacks_d}}
...
\begin{figure}[!t]
\centering
\subfloat[]{\includegraphics[width=0.47\columnwidth]{figures/fig 2a.pdf}\label{fig:cmw_a}}
\hfill
\subfloat[]{\includegraphics[width=0.47\columnwidth]{figures/fig 2b.pdf}\label{fig:cmw_b}}\\
\subfloat[]{\includegraphics[width=0.47\columnwidth]{figures/fig 2c.pdf}\label{fig:cmw_c}}
\hfill
\subfloat[]{\includegraphics[width=0.47\columnwidth]{figures/fig 2d.pdf}\label{fig:cmw_d}}
...
\begin{figure}[!t]
\centering
\subfloat[]{\includegraphics[width=0.31\columnwidth]{figures/fig 3a.pdf}\label{fig:debye_a}}
\hfill
\subfloat[]{\includegraphics[width=0.31\columnwidth]{figures/fig 3b.pdf}\label{fig:debye_b}}
\hfill
\subfloat[]{\includegraphics[width=0.31\columnwidth]{figures/fig 3c.pdf}\label{fig:debye_c}}
...
\begin{figure}[!t]
\centering
\subfloat[]{\includegraphics[width=0.47\columnwidth]{figures/fig 4a.pdf}\label{fig:cryo_a}}
\hfill
\subfloat[]{\includegraphics[width=0.47\columnwidth]{figures/fig 5b.pdf}\label{fig:cryo_b}}\\
\subfloat[]{\includegraphics[width=0.47\columnwidth]{figures/fig 4d.pdf}\label{fig:cryo_c}}
\hfill
\subfloat[]{\includegraphics[width=0.47\columnwidth]{figures/figure3/fig 3e.pdf}\label{fig:cryo_d}}
